...
# model
# for this model the parameter x should always be a numpy array of
# model.EmailFormat.SimplifiedEmail
# y needs to be a numpy array of float or int
class SpamClassifierModel:
    ...
    def train(self, x_group, y):
        ...
        x_prep, y_prep = self.dp.prepareTrainData(x_group, y)
